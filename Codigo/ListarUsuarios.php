  ...
  <div class="container" style="width: 100000px">
    ...
    require './Conectores/Conector_BD.php';
      ...
      require './Conectores/ConectorBD.php';
         ...
         function mostrarUsuarios($conector){
            $consulta="SELECT * FROM usuario";
            $resultado = mysqli_query($conector,$consulta);
            return $resultado;
        }

        $consolas = mostrarUsuarios($conector);
    ...
    while ($fila= mysqli_fetch_assoc($consolas)){
           ...
           <tr>
            ...
            <td class="tablaConsola"><textarea name="idUsuario" style="resize: both;" readonly><?php echo $fila['idUsuario'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Usuario" style="resize: both;" required><?php echo $fila['Usuario'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Password" style="resize: both;" required><?php echo $fila['Password'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Nombre" style="resize: both;" required><?php echo $fila['Nombre'] ?></textarea></td> 
            <td class="tablaConsola"><textarea name="Email" style="resize: both;" required><?php echo $fila['Email'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Rol" style="resize: both;" required><?php echo $fila['Rol'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="DNI" style="resize: both;" required><?php echo $fila['DNI'] ?></textarea></td>
            

            


            <td><button type="submit" style="cursor:pointer;" onclick="eliminarUsuario(<?php echo $fila['idUsuario'];?>)"><i class="fas fa-edit"></i></button></td>
            
           
             </form>
             <td><a href="eliminarUsuario.php?idUsuario=<?php echo $fila['idUsuario'];?>">eliminar<i class="fas fa-trash" style='font-size:20px;color:black'></i></a></td>
