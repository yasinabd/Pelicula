...
$conector = conectar(false);
      ...
      $consulta5 = "INSERT INTO pelicula
		(idPelicula,Nombre,Autores,Plataformas,Lanzamiento,Descripcion,Imagen,ruta) VALUES ('0','$Nombre','$Autores','$Plataforma','$Lanzamiento','$Descripcion','$nombreImg','$destino')";
