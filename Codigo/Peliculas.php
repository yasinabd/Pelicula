  ...
  <div class="container" style="width: 1000px">
    ...
    require './Conectores/Conector_BD.php';
      ...
      require './Conectores/ConectorBD.php';
       ...
       $listaplata="SELECT * FROM pelicula";
      $resultLista = mysqli_query($conector,$listaplata);
          if(!$resultLista) {
        var_dump(mysqli_error($conector));
        exit;
}
      
      while($juegos=mysqli_fetch_assoc($resultLista)){
    ?>
      <ul class="S1">
          <li class="S2">
            
              <h1> <?php echo $juegos['Nombre']; ?></h1>
             <a href="shop-single.php?idPelicula=<?php echo $juegos['idPelicula']; ?>">
              <img class="S3" src="imagenes/<?php echo $juegos['Imagen'];?>" height="250" width="200"></a>
