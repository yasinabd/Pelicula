...
<table style="width: 500px">
   ...
   function mostrarConsolas($conector){
        ...
        while ($fila= mysqli_fetch_assoc($consolas)){
           ...
           ?>
           <tr>
             <form action="edicionSeries.php" method="POST">

             
            <td class="tablaConsola"><textarea name="idSeries" style="resize: both;" readonly><?php echo $fila['idSeries'] ?></textarea></td>
            ...
            <td><button type="submit" style="cursor:pointer;" onclick="edicionSeries(<?php echo $fila['idSeries'];?>)"><i class="fas fa-edit"></i>modficar</button></td>
            <td><a href="eliminarSerie.php?idSeries=<?php echo $fila['idSeries'];?>">eliminar<i class="fas fa-trash" style='font-size:20px;color:black'></i></a></td>
             </form>
