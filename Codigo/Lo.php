...
<ul>
 ...
 if(isset($_SESSION['Usuario']) && $_SESSION['Rol'] == "usuario")
  ...
  <li><a href="Gestiones.html">Yasin</a></li> 
  <li> <a href="Productores.php">Productores</a>   </li> <?php  }else{
   

  echo "Hola". $conector->error;
...
<body background="fondoInd.jpg">
  <div class="container" style="width: 1000px">
         ...
         <div class="card bg-blue" style="width: 18rem; margin:0px auto">
                <div class="card-header bg-primary"> Login</div>
                <div class="card-body">  
                    <form id="Login" name="Login" action="./comprobar_usuario.php" method="POST" class="needs-validation" novalidate>
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="">Usuario:</label>
                                <input type="text" placeholder ="Introduzca su usuario" class="form-control" name="Usuario">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="Password" placeholder ="Introduzca su Password"class="form-control" name="Password" required>
                            </div>
                        </div>
                    ...
                    <a href="ingresarUs.php">Registrate</a>
                </div> <!-- div card Body-->
            </div><!-- div car -->
</div>
