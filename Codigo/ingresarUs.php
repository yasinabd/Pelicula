...
<body background="fondoInd.jpg">
  <form name="formulario" method="post" action="ingresar_usuario.php" id="loginform" onsubmit="return validarFormulario();">
                <div class="container row justify-content-center">
                    ...
                    <div class="form-group col-8 col-md-5">    
                        ...
                        <input id="CP" type="CP" class="form-control" name="CodigoPostal" placeholder="CodigoPostal" required >
                    ...
                    <div class="form-group col-8 col-md-5">
                        ...
                        <input id="CA" type="text" class="form-control" name="Comunidad" placeholder="Comunidad " required readonly="readonly">
                    </div>
