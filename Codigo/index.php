...
<body background="fondoInd.jpg">
  <div class="container" style=" padding-top: 100px;width: 100%; margin: auto;">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner" style="height: 350px">
      <div class="item active">
        <img src="imagenes/c1.jpg" alt="Los Angeles" style="width:100%; height: 350px;  margin: auto;">
      </div>

      <div class="item">
        <img src="imagenes/c2.jpg" alt="Chicago" style="width:100%; height: 350px; margin: auto;">
      </div>
    
      <div class="item">
        <img src="imagenes/c3.jpg" alt="New york" style="width:100%; height: 350px;  margin: auto;">
      </div>
    </div>
    <hr>
  ...
  <div id="myCarousel2" class="carousel slide" data-ride="carousel" >
    ...
    <div class="carousel-inner" style="height: 350px;">
      <div class="item active">
        <img src="imagenes/c4.jpg"  style="width:100%; height: 350px;  margin: auto;">
      </div>

      <div class="item">
        <img src="imagenes/c5.jpg"  style="width:100%; height: 350px;  margin: auto;">
      </div>
    
      <div class="item">
        <img src="imagenes/c6.jpg" style="width:100%; height: 350px;  margin: auto;">
      </div>
    </div>
