...
<body background="fondoInd.jpg">
  <div class="container" style="width: 1500px">
    ...
    <div class="fondoTabla" style="width: 500px">
<table style="width: 500px">
   ...
   function mostrarConsolas($conector){
        ...
        $consolas = mostrarConsolas($conector);
        while ($fila= mysqli_fetch_assoc($consolas)){

           ?>
           <tr>
             <form action="edicionPelicula.php" method="POST">

             
            <td class="tablaConsola"><textarea name="idPelicula" style="resize: both;" readonly><?php echo $fila['idPelicula'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Nombre" style="resize: both;" required><?php echo $fila['Nombre'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Autores" style="resize: both;" required><?php echo $fila['Autores'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Plataformas" style="resize: both;" required><?php echo $fila['Plataformas'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Lanzamiento" style="resize: both;" required><?php echo $fila['Lanzamiento'] ?></textarea></td>
            <td  class="tablaConsola"><textarea  type="file" name="Img" style="resize: both;" required><?php echo $fila['Imagen'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="Descripcion" style="resize: both;" required><?php echo $fila['Descripcion'] ?></textarea></td>
            <td class="tablaConsola"><textarea name="img" style="resize: both;" required><?php echo $fila['ruta'] ?></textarea></td>


            <td><button type="submit" style="cursor:pointer;" onclick="edicionPelicula(<?php echo $fila['idPelicula'];?>)"><i class="fas fa-edit"></i>modficar</button></td>
            <td><a href="eliminarPelicula.php?idPelicula=<?php echo $fila['idPelicula'];?>">eliminar<i class="fas fa-trash" style='font-size:20px;color:black'></i></a></td>
             </form>
