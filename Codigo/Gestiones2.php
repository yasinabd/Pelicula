...
<ul>
 ...
 if(isset($_SESSION['Usuario']) && $_SESSION['Rol'] == "admin") {?>
  ...
  <li><a href="Gestiones2.html"><?php print($_SESSION['Usuario']);?></a></li>
  <li> <a href="Productores.php">Productores</a>   </li>  <?php  }else{
...
<ul>
<a class="boton" href="prS.php">ingresar Pelicula</a>
<a  class="boton" href="modificarPel.php">eliminar Pelicula</a>
<a  class="boton" href="registrar_serie.php">Ingresar Series</a>
<a  class="boton" href="modificar_serie.php">eliminar Series</a>
<a class="boton" href="ListarUsuarios.php">USuarios</a>
