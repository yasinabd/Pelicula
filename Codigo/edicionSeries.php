...
$sqlc = "UPDATE series SET Nombre='$Nombre', Plataformas='$Plataformas', Lanzamiento='$Lanzamiento',  Descripcion='$Descripcion', Imagen='$nombreImg', ruta='$destino'  WHERE idSeries='$idSeries'";
